...
import co.in.nextgencoder.internsmanagementsystem.databinding.FragmentWorkspaceBinding;
...
public class WorkspaceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        workspaceViewModel =
                new ViewModelProvider(this).get(WorkspaceViewModel.class);

        binding = FragmentWorkspaceBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textWorkspace;
